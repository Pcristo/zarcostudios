...
import { MessageSquare, ArrowRight, MapPin, Phone, Mail, Linkedin, Github, CheckCircle2, AlertCircle, Loader2 } from 'lucide-react';
...
export function Contact() {
  ...
  const [formData, setFormData] = useState(() => {
    try {
      ...
      if (stored) {
        ...
        // Clear it so it won't persist across fresh contact page entries
  ...
  return (
    <section id="contact" className="py-32 bg-zarco-black relative overflow-hidden">
      {/* Toast Notification */}
      <AnimatePresence>
        {showToast && (
          <motion.div
            ...
            <div className={`p-4 rounded-2xl border shadow-2xl flex items-start gap-4 pointer-events-auto backdrop-blur-xl ${
              ...
              <div className="flex-1">
                ...
                <p className="text-sm font-medium mt-1">
                  {status === 'success' ? 'Message sent successfully!' : 'An error occurred. Please try again.'}
                </p>
              </div>
            </div>
          </motion.div>
          ...
          <div className="flex flex-col">
            ...
            <div className="space-y-10">
              ...
              >
                ...
                <a href="mailto:info@zarcostudios.com" className="text-lg md:text-xl font-black uppercase tracking-tight hover:text-zarco-cyan transition-colors break-all">
              ...
              >
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-4">
                    <a href="tel:+353899596466" className="text-xl md:text-2xl font-bold uppercase tracking-tight hover:text-zarco-cyan transition-colors">
                      (Ireland) +353 899596466
                    </a>
                  </div>
                  <div className="flex flex-col gap-1 items-start">
                    <a href="tel:+351964486091" className="text-xl md:text-2xl font-bold uppercase tracking-tight hover:text-zarco-cyan transition-colors">
              ...
              >
                ...
                <div className="space-y-4">
                  <p className="text-sm font-bold uppercase tracking-widest text-white/60">
                    <span className="text-zarco-cyan">Ireland</span> Mather South, Mount Merrion, Dublin - 4
                  </p>
                  <p className="text-sm font-bold uppercase tracking-widest text-white/60">
                    <span className="text-zarco-cyan">Portugal</span> Rua dos Caçadores, Sintra 2710 - 095
                  </p>
                </div>
              </motion.div>
              ...
              >
                <a href="https://www.linkedin.com/in/pedro-cristo/" target="_blank" rel="noopener noreferrer" className="p-3 bg-white/5 border border-white/10 rounded-xl hover:bg-zarco-cyan/10 hover:border-zarco-cyan/50 hover:text-zarco-cyan transition-all">
                  <Linkedin className="w-6 h-6" />
                </a>
                <a href="https://github.com/PedroCristo" target="_blank" rel="noopener noreferrer" className="p-3 bg-white/5 border border-white/10 rounded-xl hover:bg-zarco-cyan/10 hover:border-zarco-cyan/50 hover:text-zarco-cyan transition-all">
            ...
            <form onSubmit={handleSubmit} className="space-y-12">
              <div className="grid md:grid-cols-2 gap-12">
                <div className="flex flex-col gap-4">
                  <label className="text-[10px] font-bold tracking-[0.2em] text-white/40 uppercase">{t('contact.fields.name')}</label>
                  <Input 
                    type="text" 
                    required
                ...
                <div className="flex flex-col gap-4">
                  <label className="text-[10px] font-bold tracking-[0.2em] text-white/40 uppercase">{t('contact.fields.company')}</label>
                  <Input 
                    type="text" 
              ...
              <div className="grid md:grid-cols-2 gap-12">
                <div className="flex flex-col gap-4">
                  <label className="text-[10px] font-bold tracking-[0.2em] text-white/40 uppercase">{t('contact.fields.email')}</label>
                  <Input 
                    type="email" 
                    required
                ...
                <div className="flex flex-col gap-4">
                  <label className="text-[10px] font-bold tracking-[0.2em] text-white/40 uppercase">{t('contact.fields.phone')}</label>
                  <Input 
                    type="tel" 
              ...
              <div className="flex flex-col gap-4">
                <label className="text-[10px] font-bold tracking-[0.2em] text-white/40 uppercase">{t('contact.fields.details')}</label>
                <textarea 
                  required
